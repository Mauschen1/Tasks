...
public class Task2 {
        ...
        public static void main(String[] args){
            ...
            System.out.println(nameShuffle("кошечка собачка"));
            System.out.println(discount(89, 20));
            System.out.println(differenceMaxMin(nums));
            System.out.println(equal(1,2,3));
            System.out.println(reverse("Never let them take the light behind your eyes"));
            System.out.println( programmers(1000,1500,2000));
            System.out.println(getXO("XXXXooooxxxxOOOO"));
            System.out.println(bomb("There is the bomb!!"));
